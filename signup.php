...
<?php
   $title = "Vistagram";
   $keywords = "Vistagram, Share and capture world's moments, share, capture, share, login, signup";
   $desc = "Vistagram help in bringing together the VIT communtiy and connect.";
?>
...
<script type="text/javascript">
  $(function(){
    ...
    $('form').on('submit', (function(e){
      ...
      var vitmail = email.substring(email.length - 16);
      if(vitmail=="vitstudent.ac.in"){
        $.ajax({
        ...
        alert("Not a VIT Member, Please use vit mail");
        console.log("gvhbnjm");
        }
